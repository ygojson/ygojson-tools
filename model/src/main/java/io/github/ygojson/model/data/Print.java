...
public class Print {
	...
	@NotNull @JsonProperty(value = CommonProperties.SELF_ID, required = true)
	...
	@NotNull @JsonProperty(value = CommonProperties.CARD_ID)
	...
	@NotNull @JsonProperty(value = CommonProperties.SET_ID)
	@JsonInclude(JsonInclude.Include.NON_EMPTY)
