...
public class YgojsonIDTestData {
	 ...
	 */
	public static final YgojsonIDGenerator.YgojsonID TEST_CARD_ID = new YgojsonIDGenerator.YgojsonID(UUID.fromString("fb048a4e-4e02-5005-be71-dbe1a54c906b"), false);
	/**
	 * Expected ID for a set with the {@link #updateSetWithTestData(Set)}
	 */
	public static final YgojsonIDGenerator.YgojsonID TEST_SET_ID = new YgojsonIDGenerator.YgojsonID(UUID.fromString("08ebc888-cdda-55fb-b5e9-af5363f6cb25"), false);

	/**
	 * Expected ID for a print with the {@link #updatePrintWithTestData(Print)}
	 */
	public static final YgojsonIDGenerator.YgojsonID TEST_PRINT_ID = new YgojsonIDGenerator.YgojsonID(UUID.fromString("d1494603-370b-5ad0-a9b0-d55b39471a15"), false);
	...
	private static final UUID PRINT_CARD_ID = UUID.fromString("fb048a4e-4e02-5005-be71-dbe1a54c906b");
	private static final UUID PRINT_SET_ID = UUID.fromString("08ebc888-cdda-55fb-b5e9-af5363f6cb25");
