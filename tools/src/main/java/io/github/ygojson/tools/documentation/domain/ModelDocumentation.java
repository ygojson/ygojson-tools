...
public class ModelDocumentation {
    ...
    public ModelDocumentation(final Class<?> modelClass,
     ...
     */
    public Path writeJsonSchemaTo(final Path outputDir, final boolean force) throws YgoJsonToolException {
        ...
        try {
            ...
            throw new YgoJsonToolException("Unable to write schema file: " + outputFile, e);
        }
        return outputFile;
    }
